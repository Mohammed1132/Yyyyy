...
module.exports.run = async function({ api, event, Users }) {
	...
	if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
		...
		return api.sendMessage(`✅ KẾT NỐI THÀNH CÔNG ✅\n\nNghiêm cấm chửi hay spam bot\n(Phát hiện được hành vi trên sẽ bị banbox)\nSử dụng .help để xem all lệnh\nCảm ơn bạn đã tin tưởng và sử dụng bot tạo bởi Dang Viet Tung 💗`, threadID);
	}
	else {
		try {
