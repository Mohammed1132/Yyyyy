...
var min = Math.floor(Math.random() * 2);
  ...
  var money = data.money
      if(money < 0) api.sendMessage("Bạn cần 200 đô để xem ảnh ?",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 200})
   var callback = () => api.sendMessage({body:`Ảnh nude\nSố Ảnh: ${link.length}\n-0 đô !`,attachment: fs.createReadStream(__dirname + "/cache/10.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/10.jpg"), event.messageID); 
