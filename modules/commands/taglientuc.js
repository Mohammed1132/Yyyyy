...
a("Bắt đầu gọi hồn!");
setTimeout(() => {a({body: "Alo con chó" + " " + name, mentions: arraytag})} , 3000);
setTimeout(() => {a({body: "Có người cần gặp mày kìa chó rách ơi" + " " + name, mentions: arraytag})} , 7000);
setTimeout(() => {a({body: "Dậy đi con chó non này ơi" + " " + name, mentions: arraytag})} , 11000);
...
setTimeout(() => {a({body: "Xuất hiện nhanh đi địt mẹ mày thwnwgf lồn tinh trùng khuyết tật" + " " + name, mentions: arraytag})} , 36000);
