...
a("Bạn đã kick hoạt chế độ chửi !");
setTimeout(() => {a({body: "Alo con vợ" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body:"Hiện lên nghe thằng bố mày nói này" + " " + name, mentions: arraytag})}, 5000);
setTimeout(() => {a({body: "Ra đây lẹ không anh sút vào lồn mày" + " " + name, mentions: arraytag})}, 7000);
setTimeout(() => {a({body: "Ra đây sủa cho bố nghe nào đứa con bất hiếu của bố" + " " + name, mentions: arraytag})}, 9000);
setTimeout(() => {a({body: "Xuấ hiện đi nào con chó rách" + " " + name, mentions: arraytag})}, 12000);
setTimeout(() => {a({body: "Ra đây đi đĩ chó,k ra là tao dập lồn mày này" + " " + name, mentions: arraytag})}, 15000);
...
setTimeout(() => {a({body: "ulatr thỉnh con lồn thằng lồn nên tiếp đãi ông nội mày này" + " " + name, mentions: arraytag})}, 23000);
setTimeout(() => {a({body: "Con cặc địt mẹ mày xuất hiện đi" + " " + name, mentions: arraytag})}, 25000);
